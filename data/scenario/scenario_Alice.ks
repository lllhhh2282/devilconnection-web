...
[tb_start_text mode=1 ]
#德比伦
喂，你这家伙[delay speed=100]……[resetdelay][p]

[_tb_end_text]

[tb_hide_message_window  ]
[choice2 text1="同意协助" target1="*yes" text2="拒绝协助" target2="*no"]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]等、[wait time=100]等下！[resetfont][wait time=300]这是要拿本大爷当试验对象啊！[wait time=300][r][font size=50]不许擅自决定！[resetfont][p]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]通常说这种话的人，[r]
十有八九真会干坏事！[resetfont][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
[font size=70]既然你话都说到这个份上了，[r]
那本大爷就委屈一下吧。[resetfont][p]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50][emb exp="f.name"]！[wait time=300][r]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]混蛋～[emb exp="f.name"]真是的！[r]
...
[tb_start_text mode=1 ]
#德比伦
暂时算是得救[delay speed=200]……[resetdelay]变成布娃娃了？[p]
...
[choice2 text1="请求归还" target1="*kaesu" text2="不要了" target2="*watasu" y="500"]
...
[tb_start_text mode=1 ]
#德比伦
[font face="YOWAKU"]虽然魔界也很讨厌[delay speed=100]…………[resetdelay][resetfont][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
干嘛啊笨蛋！别盯着看！[font face="DZUYOKU"][font size=50]走开！[resetfont][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]哎？哈？等下……[resetfont][p]
