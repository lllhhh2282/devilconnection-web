...
[tb_start_text mode=1 ]
#玛尔斯
但是[delay speed=100]……[resetdelay]啊！想跟你聊天的人，[r]
其实远比你想象的多得多呢！[p]
...
[tb_start_text mode=1 ]
#德比伦
现在才注意到吗？[delay speed=100]……[resetdelay][r]
还好意思说出口……[p]
...
[tb_start_text mode=1 ]
#玛尔斯
竟然盲目崇拜恶魔[delay speed=300]……[resetdelay][p]
...
#玛尔斯
呜呜……，这是噩梦吧……[r]
没想到[emb exp="f.name"][if exp="f.seibetu == 1][else][endif]竟然在搞恶魔崇拜。[p]
...
[tb_start_text mode=1 ]
#德比伦
听好了，本大爷可是一直在罩着[delay speed=300]……[resetdelay][p]
...
#德比伦
你连别人的喜好都加以否定？[r]
照这样下去，[emb exp="f.name"]是不可能再回学校的咯～[p]
...
[tb_start_text mode=1 ]
#玛尔斯
[font size=50]呜、呜哇啊啊啊啊啊！[resetfont][r]
你说得对……，请宽恕我刚才的无礼行为。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
说到底，为什么非要让[if exp="f.seibetu == 1]他[else]她[endif][r]
去学校不可呢？[p]
[_tb_end_text]
...
[font size=25]这家伙的学校？本大爷才不会去呢……[resetfont][p]
...
[tb_start_text mode=1 ]
#玛尔斯
我有些担心，对[emb exp="f.name"][if exp="f.seibetu == 1][else][endif]是不是逼迫的[r]
过于紧迫。[r]
[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#玛尔斯
[font size=50]呜嗷嗷嗷嗷，我不配做班主任了……[resetfont][p]
[_tb_end_text]
